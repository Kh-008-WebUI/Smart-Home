...
export const DELETE_USER_PROFILE_REQUEST = 'users/DELETE_USER_PROFILE_REQUEST';
export const DELETE_USER_PROFILE_SUCCESS = 'users/DELETE_USER_PROFILE_SUCCESS';
export const DELETE_USER_PROFILE_FAILURE = 'users/DELETE_USER_PROFILE_FAILURE';
export const CLEAR_UPDATE_PROFILE_STATUS = 'users/CLEAR_UPDATE_PROFILE_STATUS';
export const CLEAR_DELETE_PROFILE_STATUS = 'users/CLEAR_DELETE_PROFILE_STATUS';
export const UPLOAD_PHOTO_FAILURE = 'users/UPLOAD_PHOTO_FAILURE';
...
export const DEVICE_UPDATE_UPLOAD_STATUS_SUCCESS =
  'builder/DEVICE_UPDATE_UPLOAD_STATUS_SUCCESS';
...
export const NOTIFICATIONS_ALL_CHANGE_STATUS =
  'NOTIFICATIONS_ALL_CHANGE_STATUS';
export const NOTIFICATIONS_ALL_CHANGE_STATUS_SUCCESS =
  'NOTIFICATIONS_ALL_CHANGE_STATUS_SUCCESS';
export const NOTIFICATIONS_SHOW_ALL_HISTORY =
  'NOTIFICATIONS_SHOW_ALL_HISTORY';
export const UPDATE_CHAT = 'ws/UPDATE_CHAT';
export const UNREAD_NOTIFICATIONS_COUNT_REQUESTED =
  'notifications/UNREAD_NOTIFICATIONS_COUNT_REQUESTED';
export const UNREAD_NOTIFICATIONS_COUNT_FETCH_SUCCESS =
  'notifications/UNREAD_NOTIFICATIONS_COUNT_FETCH_SUCCESS';
export const UNREAD_TODAYS_NOTIFICATIONS_REQUESTED =
  'notifications/UNREAD_TODAYS_NOTIFICATIONS_REQUESTED';
export const ALL_TODAYS_NOTIFICATIONS_REQUESTED =
  'notifications/ALL_TODAYS_NOTIFICATIONS_REQUESTED';
